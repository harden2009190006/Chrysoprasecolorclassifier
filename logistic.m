...
% 由 MATLAB 于 2026-02-27 09:45:39 自动生成
...
% 取出（并返回）ECOC 的每个二分类器的 Lambda
bestLambda = cellfun(@(m) m.Lambda, classificationLinear.BinaryLearners);
% 如果你只想看第1个：
% bestLambda = classificationLinear.BinaryLearners{1}.Lambda;
...
confMat = confusionmat(response, validationPredictions, 'Order', classNames);
% 计算验证准确度
